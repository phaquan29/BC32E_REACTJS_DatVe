      ...
      return cart.map((item) => {
        return (
          <tr key={item.maSP}>
            ...
            <td>
              <button className="btn btn-warning" onClick={()=>handleQuantity(item.maSP,-1)}>-</button>
      ...
      <div>
        <div>
          ...
          <div className="text-right my-4">
            ...
            >
              <i className="fa-solid fa-cart-arrow-down mr-2" />

              Giỏ hàng
              <span className="ml-3">({cart.length})-{cart.reduce((total,item)=>{
